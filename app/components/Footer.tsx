...
const footerlinks = ["Home", "About Us", "Features","Register","Storyset"] as const;
const STYLES = {
  footerLinks:
    "text-white text-base px-1 md:px-8 py-8",
};
  ...
  return (
    <section className='w-full h-[330px] bg-black border-t-2 border-white overflow-y-clip overflow-hidden'>
      <div className="flex flex-col items-center justify-between gap-6 py-20 pb-8">
        ...
        <p className='text-base text-white font-montserrat'>Copyright CareerSprint© 2024</p>
      </div>
    </section>
    )
}
