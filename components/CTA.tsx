    ...
    <section className="pt-8 pb-10 lg:pt-5 lg:pb-10 bg-black md:h-screen ">
      <div className="container">
        <div className="flex items-center justify-between md:px-36">
          <div className="hidden md:block justify-between items-center scale-90 py-10 md:py-28">
            <Image src={ctaImage} alt="cta" className="" />
          </div>
          <div className="lg:w-[478px] flex flex-col px-8 gap-4 items-center justify-between">
            <h2 className="font-ptserif font-bold text-center text-white mt-6 text-5xl leading-tight">
              Ready To Sprint <br /> Towards <br /> Your{" "}
              <span className="text-transparent bg-gradient-to-r from-[#ff3131] to-[#ff914d] bg-clip-text">
                {" "}
                Career Goals
              </span>
              ?
            </h2>
            <p className="text-base w-[400px] text-white mt-6 font-montserrat text-center">
              Join CareerSprint today and take the <br /> first step towards
